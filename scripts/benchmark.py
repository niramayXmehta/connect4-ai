...
#   python scripts/benchmark.py --games 200 --depth 6
import sys
import time
import argparse
...
parser.add_argument('--games', type=int, default=200, help='Games per matchup (default: 200)')
parser.add_argument('--depth', type=int, default=6,   help='Search depth (default: 6)')
args = parser.parse_args()

cfg = {'games': args.games, 'depth': args.depth}
